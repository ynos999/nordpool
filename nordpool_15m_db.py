...
for row in rows:
    ...
    if len(cells) >= 2:
        ...
        if period.startswith("00:"):
            ...
            delivery_date = tomorrow_str  # after_tomorrow_str
        else:
            delivery_date = today_str  # tomorrow_str
...
filename = f"LV_price_db_{today_str}.csv"  # Change if neead to tomorrow_str
